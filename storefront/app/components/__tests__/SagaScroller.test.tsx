...
const screens: HomeScreen[] = [
  {key: 'a', kind: 'saga', kicker: 'K', title: 'Saga A', lore: null, author: null, accent: null, covers: [{url: 'u', altText: 'a'}], background: null, href: '/c#a', ctaLabel: 'Entrer dans la saga'},
  {key: 'b', kind: 'oneshot', kicker: 'Roman indépendant', title: 'Œuvre B', lore: null, author: null, accent: null, covers: [{url: 'u', altText: 'b'}], background: null, href: '/products/b', ctaLabel: 'Découvrir le livre'},
];
